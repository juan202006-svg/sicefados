...
<div class="container mt-4">
    ...
    <div class="card shadow-sm border-0">
        <div class="table-responsive">
            <table id="actividades" class="table table-hover table-bordered align-middle text-center">
...
<div class="container mt-5">
    ...
    <div class="card shadow-sm border-0">
        <div class="table-responsive">
            <table id="control" class="table table-hover table-bordered align-middle text-center">
                <thead style="background-color: #f8f9fa;">
                    <tr>
                        <th>Codigo</th>
                        <th>Actividad</th>
