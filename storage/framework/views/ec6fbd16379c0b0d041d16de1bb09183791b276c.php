                ...
                <table id="seguimientoresiembra" class="table table-hover table-bordered text-center align-middle">
                    ...
                    <tbody>
                        ...
                        <tr class="table-light">
                            ...
                            <td><?php echo e($sr->aquaponicSystem->name ?? 'Sin sistema'); ?></td>
                            <td><?php echo e($sr->resowing->crops->species->name ?? 'Sin cultivo'); ?></td>
                            <td><?php echo e($sr->plant_count); ?></td>
                            <td>
                                <span class="color-circle-large" style="background-color: <?php echo e($sr->color_tone); ?>;"></span>
                            </td>
                            <td><?php echo e($sr->height_cm); ?> cm</td>
                            <td><?php echo e($sr->days_elapsed); ?></td>
                            <td><?php echo e($sr->growth); ?> cm</td>
                            <td><?php echo e($sr->mortality); ?></td>
                            <td><?php echo e($sr->notes ?? 'Sin novedades'); ?></td>
                        </tr>
