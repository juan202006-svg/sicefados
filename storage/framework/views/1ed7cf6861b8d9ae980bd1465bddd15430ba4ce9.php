            ...
            <table id="tabla-cultivos" class="table table-hover table-bordered align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($ch->date); ?></td>
                        <td class="text-center"><?php echo e($ch->crops->species->name); ?></td>
                        <td class="text-center"><?php echo e($ch->quantity); ?></td>
                        <td class="text-center"><?php echo e($ch->unit); ?></td>
                        <td class="text-center"><?php echo e($ch->destination); ?></td>
                        <td class="text-center"><?php echo e($ch->mortality); ?></td>
                        <td class="text-center"><?php echo e($ch->notes); ?></td>
                        <td class="text-center">
                            <button type="button" class="btn btn-success btn-sm editbtn"
                                data-id="<?php echo e($ch->id); ?>"
                                data-date="<?php echo e($ch->date); ?>"
                                data-crop_id="<?php echo e($ch->crop_id); ?>"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="edit-crop_id" name="crop_id" required>
                                    ...
                                    <option value="<?php echo e($cultivo->id); ?>" data-quantity="<?php echo e($cultivo->quantity); ?>"><?php echo e($cultivo->species->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="crop_id" id="crop_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $cultivos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cultivo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                value="<?php echo e($cultivo->id); ?>" data-quantity="<?php echo e($cultivo->quantity); ?>">
                                <?php echo e($cultivo->species->name); ?>
