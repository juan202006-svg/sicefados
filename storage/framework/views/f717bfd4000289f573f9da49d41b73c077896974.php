                ...
                <tbody>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <button class="action-btn edit" data-bs-toggle="modal" data-bs-target="#editModal<?php echo e($activity->id); ?>" title="Editar">
                ...
                <tbody>
                    ...
                    <?php $__currentLoopData = $evidenciasAdmin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evidencia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <?php if($evidencia->evidence && Storage::disk('public')->exists($evidencia->evidence)): ?>
                                    <button class="action-btn view" data-bs-toggle="modal" data-bs-target="#verPdfModal<?php echo e($evidencia->id); ?>" title="Ver PDF">
