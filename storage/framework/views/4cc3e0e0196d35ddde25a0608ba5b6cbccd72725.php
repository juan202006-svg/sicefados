            ...
            <table id="seguimientosTable" class="table table-hover table-bordered align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($seguimiento->crops->aquaponicSystem->name ?? 'Sin sistema'); ?></td>
                        <td class="text-center"><?php echo e($seguimiento->date); ?></td>
                        <td class="text-center"><?php echo e($seguimiento->crops->species->name ?? 'Sin cultivo'); ?></td>
