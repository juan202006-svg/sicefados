                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="#submenuResiembra"
                           class="nav-link <?php echo e(request()->routeIs(['acuaponico.pasante.pasante.indexresowing', 'acuaponico.pasante.pasante.indexresowingtracking']) ? 'active' : ''); ?>"
                        ...
                        <ul class="collapse nav flex-column ms-3 <?php echo e(request()->routeIs(['acuaponico.pasante.pasante.indexresowing', 'acuaponico.pasante.pasante.indexresowingtracking']) ? 'show' : ''); ?>"
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('acuaponico.admin.admin.registroresiembras')); ?>"
                                   class="nav-link <?php echo e(request()->routeIs('acuaponico.pasante.pasante.indexresowing') ? 'active' : ''); ?>">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('acuaponico.pasante.pasante.indexresowingtracking')); ?>"
                                   class="nav-link <?php echo e(request()->routeIs('acuaponico.pasante.pasante.indexresowingtracking') ? 'active' : ''); ?>">
