...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('AdminLTE/dist/img/IconoAcuaponico.png')); ?>" type="image/x-icon" style="border-radius: 10px;">
    <!-- Fuente -->
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand" style="background-color: #058799">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(route ('cefa.acuaponico.index')); ?>" class="nav-link text-white">Inicio</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar elevation-4" style="background-color: #3eacbb; color: white; padding-top: 42px;">
            <a href="" class="brand-link d-flex flex-column align-items-center py-3" style="text-decoration: none;">
                <img src="<?php echo e(asset('AdminLTE/dist/img/Logo_Acuaponico.png')); ?>"
                    alt="Logo Acuapónico"
            ...
            <div class="sidebar">
                ...
                <nav class="mt-6">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.welcomepas')); ?>" class="nav-link" id="gestionLotes">
                                <i class="fas fa-th-large"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.acuaponicoindex')); ?>" class="nav-link" id="gestionLotes">
                                <i class="fas fa-th-large"></i>
                                <p>sistemas Acuaponicos</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.index')); ?>" class="nav-link" id="gestionLotes">
                                <i class="fas fa-th-large"></i>
                                <p>Gestión de Lotes</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.categoria')); ?>" class="nav-link" id="gestionCategorias">
                                <i class="fas fa-tags"></i>
                                <p>Gestión de Categorias</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.indexspecies')); ?>" class="nav-link" id="gestionCategorias">
                                <i class="fas fa-dna"></i>
                                <p>Gestión de Especies</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.crops')); ?>" class="nav-link" id="gestionCategorias">
                                <i class="fas fa-seedling"></i>
                                <p>Gestión de Cultivos</p>
                            </a>
                        </li>
                         <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.indexresowing')); ?>" class="nav-link" id="gestionCategorias">
                                <i class="fas fa-tags"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="submenuSeguimiento">
                                <ul class="nav flex-column ms-3">
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('acuaponico.pasante.pasante.indextracking')); ?>" class="nav-link">
                                            <i class="fas fa-chart-line"></i>
                                            <p>Seguimientos Generales</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('acuaponico.pasante.pasante.indextrakingfish')); ?>" class="nav-link">
                                            <i class="fas fa-fish"></i>
                                            <p>Seguimientos Peces</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('acuaponico.pasante.pasante.indextrackingplant')); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route ('acuaponico.pasante.pasante.indexharvest')); ?>" class="nav-link" id="gestionCategorias">
                                <i class="fas fa-tractor"></i>
                                <p>Gestion de Cosechas</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('acuaponico.pasante.pasante.indexactivity')); ?>" class="nav-link" id="gestionCategorias">
