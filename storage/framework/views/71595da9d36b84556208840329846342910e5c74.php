        ...
        <form action="<?php echo e(route('acuaponico.admin.admin.updateUsuarios', $usuario->id)); ?>" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title w-100 text-center" id="editModalLabel<?php echo e($usuario->id); ?>">
                        <i class="fas fa-edit me-2"></i>Editar Usuario: <span class="user-name-display"><?php echo e($usuario->first_name); ?> <?php echo e($usuario->last_name); ?></span>
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-info mb-4">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <span class="badge <?php echo e($usuario->role == 'instructor' ? 'bg-warning' : 'bg-info'); ?> current-user-role">
                                    <?php echo e(ucfirst($usuario->role)); ?>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="first_name_<?php echo e($usuario->id); ?>" class="form-label fw-semibold">
                                <i class="fas fa-user me-2 text-primary"></i>Nombre
                            </label>
                            <input type="text" name="first_name" id="first_name_<?php echo e($usuario->id); ?>" class="form-control form-control-lg" value="<?php echo e($usuario->first_name); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="last_name_<?php echo e($usuario->id); ?>" class="form-label fw-semibold">
                                <i class="fas fa-user me-2 text-primary"></i>Apellidos
                            </label>
                            <input type="text" name="last_name" id="last_name_<?php echo e($usuario->id); ?>" class="form-control form-control-lg" value="<?php echo e($usuario->last_name); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="role_<?php echo e($usuario->id); ?>" class="form-label fw-semibold">
                                <i class="fas fa-user-tag me-2 text-primary"></i>Rol
                            </label>
                            <select name="role" id="role_<?php echo e($usuario->id); ?>" class="form-select form-select-lg" required>
                        ...
                        <div class="col-md-6">
                            <label for="status_<?php echo e($usuario->id); ?>" class="form-label fw-semibold">
                                <i class="fas fa-toggle-on me-2 text-primary"></i>Estado
                            </label>
                            <select name="status" id="status_<?php echo e($usuario->id); ?>" class="form-select form-select-lg" required>
                        ...
                        <div class="col-12">
                            <label for="productive_unit_id_<?php echo e($usuario->id); ?>" class="form-label fw-semibold">
                                <i class="fas fa-building me-2 text-primary"></i>Unidad Productiva
                            </label>
                            <select name="productive_unit_id" id="productive_unit_id_<?php echo e($usuario->id); ?>" class="form-select form-select-lg" required>
                                <option value="">-- Seleccione --</option>
                                <?php $__currentLoopData = $unidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unidad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
