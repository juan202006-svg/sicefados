                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-top">
                                    ...
                                    <td class="text-center"><?php echo e(\Carbon\Carbon::parse($lot->date)->format('d/m/Y')); ?></td>
                                    <td class="text-center">
                                        <span class="d-inline-block text-truncate" style="max-width: 150px;"><?php echo e($lot->name); ?></span>
                                    </td>
                                    <td class="text-center"><?php echo e($lot->capacity); ?></></td>
                                    <td class="text-center"><?php echo e($lot->ocupado); ?></td>
                                    <td class="text-center">
                                        <?php if($lot->disponible > 0): ?>
                                        <span class="badge rounded-pill bg-success bg-opacity-10 text-success"><?php echo e($lot->disponible); ?></span>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($lot->image): ?>
                                            <img src="<?php echo e(asset('storage/lotes/' . $lot->image)); ?>" alt="Imagen del lote" style="width: 60px; height: 60px; object-fit: cover; border-radius: 8px;">
                                        <?php else: ?>
                                    ...
                                    <td class="text-end pe-4">
                                        <div class="d-flex gap-2 justify-content-end">
                                            ...
                                            <button type="button" class="btn btn-sm btn-outline-danger btnEliminar" data-id="<?php echo e($lot->id); ?>">
...
<div class="modal fade" id="updateLot" tabindex="-1" aria-labelledby="updateLotLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="width: 40%;">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
            <form id="formEditar" action="<?php echo e(route('acuaponico.pasante.pasante.updateLot', 0)); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
                <?php echo method_field('put'); ?>
                <!-- Encabezado con gradiente y sombra -->
                <div class="modal-header py-3" style="background: linear-gradient(135deg, #2abef5 0%, #6dc9dd 100%);">
                    <input type="hidden" name="from" value="<?php echo e(request()->routeIs('acuaponico.admin.*') ? 'admin' : 'pasante'); ?>">
