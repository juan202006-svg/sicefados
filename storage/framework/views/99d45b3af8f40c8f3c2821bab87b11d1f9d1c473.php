                ...
                <table id="lotesTable" class="table table-hover align-middle mb-0" style="border: 1px solid #dee2e6;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeInRight" style="animation-delay: <?php echo e($n * 0.05); ?>s; border-bottom: 1px solid #dee2e6;">
                            ...
                            <td class="fw-medium" style="border-right: 1px solid #dee2e6; padding: 12px 8px;"><?php echo e($lot->aquaponicSystem->name ?? 'sin lote'); ?></td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;"><?php echo e($lot->date); ?></td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;"><?php echo e($lot->name); ?></td>
                            <td class="text-center fw-bold" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">
                                <span class="badge bg-info rounded-pill px-3 py-2"><?php echo e($lot->capacity); ?></span>
                            </td>
                            ...
                            <td class="text-center fw-bold" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">
                                <span class="badge bg-warning rounded-pill px-3 py-2"><?php echo e($lot->ocupado); ?></span>
                            </td>
                            <td class="text-center" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">
                                <?php if($lot->disponible > 0): ?>
                                <span class="badge badge-success rounded-pill px-3 py-2 pulse-active"><?php echo e($lot->disponible); ?></span>
                                <?php else: ?>
                            ...
                            <td class="text-center" style="padding: 12px 8px;">
                                <div class="d-flex justify-content-center action-buttons">
                                    ...
                                    <button type="button" class="btn btn-action btn-delete btnEliminar" data-id="<?php echo e($lot->id); ?>">
                                        <div class="btn-icon">
