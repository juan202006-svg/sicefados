...
<style>
    ...
    body {
        background-color: #eafaf1; /* Fondo general claro */
    }
    .main-header {
        background-color: #5bc0de !important; /* Navbar azul claro */
    }
    .main-sidebar {
        background-color: #3eacbb !important; /* Sidebar verde azulado */
        color: white;
    }
    .nav-link, .nav-link i {
    ...
    .nav-link:hover {
        background-color: #6fcb9f !important; /* Hover verde suave */
        color: white !important;
    }
    .brand-link {
    ...
    .main-footer {
        background-color: #2f4f4f !important; /* Gris oscuro elegante */
        color: white;
    }
    .main-footer a {
        color: #a3d9a5;
...
<body class="hold-transition sidebar-open layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <style>
            .nav-link {
                border-radius: 30px; /* Hace la animación redonda */
                transition: background-color 0.3s ease, color 0.3s ease;
            }
        
            .nav-link:hover {
                background-color: rgba(255, 255, 255, 0.2); /* Color claro con transparencia */
                color: #e0f7fa !important; /* Cambia color del texto en hover, sutilmente */
            }
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('[data-widget="pushmenu"]').PushMenu({ autoCollapseSize: false });
            });
        </script>
...
<a href="index3.html" class="brand-link" style="display: flex; align-items: center; padding: 10px;">
    <img src="{{ asset('AdminLTE/dist/img/logoaco.png') }}" alt="AdminLTE Logo"
        class="img" style="width: 100px; height: 80px; border-radius: 50%; margin-right: 10px;">
    <span class="brand-text" style="font-size: 20px; color: white; font-weight: bold; margin-top: -55px;">Acuaponia</span>
</a>
