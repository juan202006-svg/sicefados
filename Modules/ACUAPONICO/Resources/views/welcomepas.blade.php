                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h4 mb-0 font-weight-bold text-gray-800">{{ $systems->count() }}</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h4 mb-0 font-weight-bold text-gray-800">{{ $availableLotsCount }}</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h4 mb-0 font-weight-bold text-gray-800">{{ $cropsCount }}</div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h4 mb-0 font-weight-bold text-gray-800">{{ $resowingsCount }}</div>
            ...
            <div class="card shadow-lg mb-4 rounded-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        @foreach($cropsBySystem as $item)
                            <span class="mr-2">
                                <i class="fas fa-circle" style="color: #{{ sprintf('%06X', mt_rand(0, 0xFFFFFF)) }}"></i> Sistema {{ $item->aquaponic_system_id }}
                            </span>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="col-xl-6 col-lg-6">
            <div class="card shadow-lg mb-4 rounded-lg">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        @foreach($resowingsByStatus as $item)
                            <span class="mr-2">
                                <i class="fas fa-circle" style="color: #{{ sprintf('%06X', mt_rand(0, 0xFFFFFF)) }}"></i> {{ $item->status }}
                            </span>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card bg-gradient-danger text-white shadow-lg rounded-lg hover-scale">
                <div class="card-body text-center">
                    ...
                    <div class="h3 mb-2">{{ $cropsCount }}</div>
                    <div class="small">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var cropsBySpeciesData = @json($cropsBySpecies ?? []);
        ...
        var resowingsByStatusData = @json($resowingsByStatus ?? []);
