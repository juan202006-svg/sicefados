                ...
                <table id="seguimientosTable" class="table table-hover align-middle mb-0" style="border: 1px solid #dee2e6;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeInRight" style="animation-delay: {{ $n * 0.05 }}s; border-bottom: 1px solid #dee2e6;">
                            ...
                            <td class="fw-medium" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $seguimiento->crops->aquaponicSystem->name ?? 'Sin sistema'}}</td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $seguimiento->date }}</td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $seguimiento->crops->species->name ?? 'Sin cultivo' }}</td>
                            <td class="text-center fw-bold" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">
                                <span class="badge bg-info rounded-pill px-3 py-2">{{ $seguimiento->days_elapsed }}</span>
                            </td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;">
                                @if ($seguimiento->notes)
                                <span class="text-muted" data-toggle="tooltip" title="{{ $seguimiento->notes }}">{{ Str::limit($seguimiento->notes, 40) }}</span>
                                @else
                            ...
                            <td class="text-center" style="padding: 12px 8px;">
                                <div class="d-flex justify-content-center action-buttons">
                                    ...
                                    <button type="button" class="btn btn-action btn-delete btnEliminar" data-id="{{ $seguimiento->id }}">
                                        <div class="btn-icon">
