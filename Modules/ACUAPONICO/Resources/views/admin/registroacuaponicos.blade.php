        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <small class="text-muted">Total de sistemas: {{ count($acuaponico) }}</small>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: {{ $n * 0.03 }}s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">
                                @if ($item->description)
                                <span class="text-muted" data-toggle="tooltip" title="{{ $item->description }}">{{ Str::limit($item->description, 40) }}</span>
                                @else
                                <span class="text-muted font-italic">Sin descripción</span>
                                @endif
                            </td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">{{ $item->location }}</td>
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                ...
                                <img src="{{ asset('modules/acuaponico/images/acuaponico/' . $item->image) }}" 
                                     ...
                                     data-toggle="modal" data-target="#imageModal" data-image="{{ asset('modules/acuaponico/images/acuaponico/' . $item->image) }}">
                                @else
                            ...
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-info rounded-pill px-3 py-2 shadow-sm">{{ $item->lot_capacity }}</span>
                            </td>
                            <td class="text-center py-3" style="border-right: 1px solid #e3e6f0;">
                                @if($item->active)
...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregarLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="overflow: hidden;">
            ...
            <form action="{{ route('acuaponico.pasante.pasante.acuaponicostore') }}" method="POST" enctype="multipart/form-data" id="formAgregar">
                @csrf
