                        ...
                        <tr class="border-top">
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-danger btnEliminar" data-id="{{ $item->id }}">
...
<div class="modal fade" id="agregar" tabindex="-1" aria-labelledby="agregarLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="width: 40%;">
        <form action="{{ route('acuaponico.pasante.pasante.storeCategory') }}" method="POST" class="needs-validation" novalidate>
            @csrf
...
<div class="modal fade" id="editar" tabindex="-1" aria-labelledby="editarLabel" aria-hidden="true" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="width: 40%;">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 15px; overflow: hidden;">
            <form id="formEditar" action="{{ route('acuaponico.pasante.pasante.updateCategory', 0) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('put')
