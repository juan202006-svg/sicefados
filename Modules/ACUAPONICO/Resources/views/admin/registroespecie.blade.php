                ...
                <table id="especiesTable" class="table table-hover align-middle mb-0" style="border: 1px solid #dee2e6;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeInRight" style="animation-delay: {{ $n * 0.05 }}s; border-bottom: 1px solid #dee2e6;">
                            ...
                            <td class="fw-medium" style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $especie->category->name ?? 'Sin categoría' }}</td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $especie->scientific_name }}</td>
                            <td style="border-right: 1px solid #dee2e6; padding: 12px 8px;">{{ $especie->name }}</td>
                            ...
                            <td class="text-center" style="padding: 12px 8px;">
                                <div class="d-flex justify-content-center action-buttons">
                                    ...
                                    <button type="button" class="btn btn-action btn-delete btnEliminar" data-id="{{ $especie->id }}">
                                        <div class="btn-icon">
