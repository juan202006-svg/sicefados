        ...
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <small class="text-muted">Total de cultivos: {{ count($cultivos) }}</small>
                </div>
                ...
                <table id="cultivoTable" class="table table-hover align-middle mb-0" style="border: 1px solid #e3e6f0;">
                    ...
                    <tbody>
                        ...
                        <tr class="animate__animated animate__fadeIn" style="animation-delay: {{ $n * 0.03 }}s; border-bottom: 1px solid #e3e6f0; transition: all 0.3s ease;">
                            ...
                            <td class="fw-medium py-3" style="border-right: 1px solid #e3e6f0;">{{ $cultivo->date }}</td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">{{ $cultivo->aquaponicSystem->name ?? 'Sin sistema' }}</td>
                            <td class="py-3" style="border-right: 1px solid #e3e6f0;">{{ $cultivo->species->name ?? 'Sin especie' }}</td>
                            ...
                            <td class="text-center fw-bold py-3" style="border-right: 1px solid #e3e6f0;">
                                <span class="badge bg-primary rounded-pill px-3 py-2 shadow-sm">{{ $cultivo->quantity }}</span>
                            </td>
                            ...
                            <td class="text-center py-3">
                                <div class="d-flex justify-content-center action-buttons">
                                    ...
                                    <!-- Botón de Eliminar -->
                                    <button type="button" class="btn btn-action btn-delete btnEliminar mx-1" data-id="{{ $cultivo->id }}">
                                        <div class="btn-icon">
